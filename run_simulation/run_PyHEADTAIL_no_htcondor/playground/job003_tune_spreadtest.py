...
scan_stdAmpNoise = [1e-6,  1e-4, 1e-2, 1e-10, 1e-8]
for stdAmpNoise in scan_stdAmpNoise:
    print(stdAmpNoise)
    X = []
    Y = []
    ...
    plt.scatter(Qx_list, Qy_list, label='std noise={}'.format(stdAmpNoise))
plt.ylim(0.179, 0.1825)
