...
one_turn_map.append(transverse_map[0])
#one_turn_map.append(wake_field_0)
#one_turn_map.append(wake_field_1)
one_turn_map.append(wake_field_2)
one_turn_map.append(wake_field_3)
